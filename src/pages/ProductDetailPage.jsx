...
export default function ProductDetailPage() {
  ...
  */
  ...
  // determinar si el usuario puede ver el detalle del producto
  const canSeeProduct =
    ...
    <>
      {isStoreOwner && store?.active === false && (
        <div className="bg-warning-100 border border-warning-300 text-warning-800 px-6 py-4 rounded-md my-6 text-center">
          ⚠️ <strong>Tienda inactiva</strong> — solo tú puedes ver este producto
          mientras la tienda esté desactivada.
        </div>
      )}
      ...
      {canSeeProduct ? (
                    ...
                    >
                      {user ? (
                        ...
                        viewersCount > 1 && (
                          <>
                            <User size={16} />
                            Otras {viewersCount - 1} personas viendo este
                            producto ahora
                          </>
                        )
                      ) : (
                  ...
                  >
                    ...
                    >
                      <p className="pb-4">
                        ...
                        elit. Incidunt eveniet expedita voluptatem facere unde
                        itaque odit commodi praesentium? Amet sed suscipit culpa
                        in commodi maxime consequuntur adipisci, ratione nulla
                        quae?
                      </p>
                    </AccordionItem>
                  </Accordion>
        ...
        <div className="container mx-auto px-8 py-16 text-center">
          <h2 className="text-2xl font-semibold mb-4">
            No es posible mostrar este producto en este momento
          </h2>
          <p className="text-gray-600">
            El producto pertenece a una tienda que actualmente está inactiva.
          </p>
        </div>
      )}
