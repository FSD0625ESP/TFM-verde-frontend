...
export const StoreProvider = ({ children, initialStore = null }) => {
    ...
    const removeSliderImage = useCallback((imageUrl) => {
        setStoreData((prev) => ({
            ...
            appearance: {
                ...prev.appearance,
                sliderImages: prev.appearance?.sliderImages?.filter(
                    (img) => img !== imageUrl
                ) || [],
            },
        }));
